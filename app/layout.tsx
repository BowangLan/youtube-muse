...
export const metadata: Metadata = {
  ...
  keywords: ['YouTube music', 'playlist manager', 'music player', 'YouTube playlists', 'online music', 'streaming music', 'music organizer'],
  ...
  twitter: {
    ...
    title: 'YouTube Muse - Your Personal Music Playlist Manager',
    description: 'Create, manage, and enjoy your favorite YouTube music playlists with YouTube Muse.',
