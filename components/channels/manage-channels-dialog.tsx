...
export function ManageChannelsDialog({ trigger }: ManageChannelsDialogProps) {
  ...
  return (
    ...
    >
      ...
      <DialogContent className="w-[92vw] max-h-[85vh] overflow-hidden rounded-3xl border border-white/10 bg-[#070707] p-0 text-white motion-preset-slide-up-sm sm:max-w-3xl">
        <div
          aria-hidden="true"
        ...
        />
        <div className="relative flex max-h-[85vh] min-h-0 flex-col gap-6 overflow-y-auto p-6 sm:h-[70vh] sm:overflow-hidden sm:p-8">
          <DialogHeader>
          ...
          <div className="grid min-h-0 flex-1 gap-6 overflow-hidden sm:grid-cols-2">
            <div className="flex min-h-0 flex-col gap-3">
              ...
              <div className="min-h-[5.5rem] max-h-[34vh] space-y-2 overflow-y-auto pr-1 sm:max-h-[48vh]">
                {channels.length === 0 ? (
            ...
            <div className="flex min-h-0 flex-col gap-3">
              ...
              <div className="min-h-[5.5rem] flex-1 space-y-2 overflow-y-auto pr-1">
                {searchResults.length > 0
                  ? searchResults.map((result) => {
                      const isAdded = existingChannelIds.includes(
                        result.channelId
                      );
