export const DESKTOP_IPC_CHANNELS = {
  ...
  mainWindowCompactToggle: "desktop:main-window-compact-toggle",
  mainWindowIsCompact: "desktop:main-window-is-compact",
  mainWindowCompactChanged: "desktop:main-window-compact-changed",
